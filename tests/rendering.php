...
// Run against an installed Craft 4 project's dependencies without booting its application or database.
$autoload = getenv('CRAFT_VENDOR_AUTOLOAD') ?: dirname(__DIR__) . '/vendor/autoload.php';
if (!is_file($autoload)) {
    fwrite(STDERR, "Set CRAFT_VENDOR_AUTOLOAD to a Craft 4 project's vendor/autoload.php.\n");
    exit(1);
}
